...
def train(data_dir, hashtable_save_path, model_save_path, shape_code_save_path):
    ...
    # ========= new sampling ========
    sample_points_non_surface = np.load('temp_plane_data/cube_60w/cloud_points.npz')
    sample_points_surface = np.load('temp_plane_data/cube_60w/surface_points.npz')
...
if __name__ == "__main__":
    ...
    trained_model_dir = 'hashtable/cube/cube_nooutputactivation_sample60w_lowmaxres'
    save_dir = 'hashtable/cube/cube_nooutputactivation_sample60w_lowmaxres'
