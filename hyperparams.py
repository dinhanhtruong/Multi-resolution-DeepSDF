...
# preprocess/data
num_sample_points = 50000 #500000
...
# hashtable 
table_sz = 2**14 # num entries per table, [2*14, 2**24]
max_resolution = 512 # max grid length sz [512, 512*1024=524288]

#MLP
hidden_dim = 512 # 512   must be at least shape_code_dim + encoded_pos_dim
clamping_dist = 0.1
