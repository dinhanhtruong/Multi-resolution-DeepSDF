...
class Quantizer(nn.Module):
    ...
    def forward(self, grid_feat):
        ...
        codes_used = torch.unique(encoding_indices)
        number_of_codes_used = codes_used.shape[0]
        self.number_of_codes_used = number_of_codes_used
